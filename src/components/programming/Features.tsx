    ...
    <div className="flex flex-col px-52 gap-6 py-20">
      <div className="flex flex-col items-center">
        ...
        <div className="p-4 flex justity-center items-center">
          <div className="bg-custom-gradient p-2 rounded-[30px] font-medium flex gap-2 md:gap-6 shadow-md">
            {ageGroups.map((age) => (
              <button
                key={age}
      ...
      <p className="font-extrabold text-2xl px-16">Programming Courses</p>
