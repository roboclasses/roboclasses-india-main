  ...
  return (
    <div className="flex flex-col lg:gap-10 gap-8 items-center lg:p-20 p-10">
      <div className="flex flex-col lg:gap-6 gap-2 text-center">
        <h1 className="lg:text-4xl text-2xl font-bold">Child’s learning path</h1>
        <p className="lg:text-base text-xs" style={{ letterSpacing: "0.05em" }}>Recommended learning path</p>
      </div>
      <div className="grid lg:grid-cols-4 grid-cols-2 gap-6 relative">
        {Items.map((item) => (
          <Card
            ...
            ease-linear dark:shadow-black bg-[#F0F0F0] relative"
            key={item.age}
          >
