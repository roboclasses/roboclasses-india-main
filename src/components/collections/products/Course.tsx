...
import { BenefitsData, LearnData, SyllabusData } from "@/data/ProductsData";
    ...
    <div className="flex flex-col items-center justify-center gap-20 lg:px-20 px-10">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
            {LearnData.map((item) => (
              ...
              >
                ...
                <p className="font-bold lg:text-base text-sm">{item.title}</p>
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 w-[1100px]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2 ml-6 text-balance" style={{ letterSpacing: "0.05em" }}>
            {BenefitsData.map((item) => (
              <ul key={item.id} className="list-disc list-inside font-medium">
                <li>{item.benefit}</li>
              </ul>
            ))}
          </div>
