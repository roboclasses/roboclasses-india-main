...
const HeroSection = () => {
  const Data = [
    {id:1, title: "2400+", desc: "Students" },
    {id:2, title: "1 : 1 or group classes", desc: "Live online learning" },
    {id:3, title: "40+", desc: "Specialized courses" },
    {id:4, title: "12000+", desc: "hours of learning" },
  ];

  return (
    <div className="mt-[30px]">
      <div
        className="bg-cover bg-center h-[300px] sm:h-[400px] md:h-[500px] lg:h-[500px] xl:h-[600px] p-20 rounded-t-3xl"
