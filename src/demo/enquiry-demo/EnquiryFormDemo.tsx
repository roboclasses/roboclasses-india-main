  ...
  return (
    <Form {...form}>
      <form
        ...
        className=" lg:w-1/2 flex flex-col gap-8 border-t-8 border-orange-500  dark:bg-gray-800 dark:text-white items-center h-auto space-y-2 p-10 rounded-lg shadow-2xl"
      >
